...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CartInfo.date'
        db.delete_column('breeze_cartinfo', 'date')

        # Adding field 'CartInfo.date_created'
        db.add_column('breeze_cartinfo', 'date_created',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=0, blank=True),
                      keep_default=False)

        # Adding field 'CartInfo.date_updated'
        db.add_column('breeze_cartinfo', 'date_updated',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(2014, 9, 10, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'CartInfo.date'
        db.add_column('breeze_cartinfo', 'date',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=0, blank=True),
                      keep_default=False)

        # Deleting field 'CartInfo.date_created'
        db.delete_column('breeze_cartinfo', 'date_created')

        # Deleting field 'CartInfo.date_updated'
        db.delete_column('breeze_cartinfo', 'date_updated')
