...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'apps.appname'
        db.delete_column('breeze_apps', 'appname')


    def backwards(self, orm):
        # Adding field 'apps.appname'
        db.add_column('breeze_apps', 'appname',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=35, unique=True),
                      keep_default=False)
