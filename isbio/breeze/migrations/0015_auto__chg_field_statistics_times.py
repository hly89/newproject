...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Statistics.times'
        db.alter_column('breeze_statistics', 'times', self.gf('django.db.models.fields.PositiveSmallIntegerField')())

    def backwards(self, orm):

        # Changing field 'Statistics.times'
        db.alter_column('breeze_statistics', 'times', self.gf('django.db.models.fields.IntegerField')())
