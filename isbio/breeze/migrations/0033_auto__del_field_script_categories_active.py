...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Script_categories.active'
        db.delete_column('breeze_script_categories', 'active')


    def backwards(self, orm):
        # Adding field 'Script_categories.active'
        db.add_column('breeze_script_categories', 'active',
