...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ScriptCategories'
        db.create_table('breeze_scriptcategories', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('script_category', self.gf('django.db.models.fields.CharField')(max_length=55)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=350, blank=True)),
        ))
        db.send_create_signal('breeze', ['ScriptCategories'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'ScriptCategories'
        db.delete_table('breeze_scriptcategories')
    ...
    models = {
        ...
        'breeze.scriptcategories': {
            'Meta': {'object_name': 'ScriptCategories'},
            'description': ('django.db.models.fields.CharField', [], {'max_length': '350', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'script_category': ('django.db.models.fields.CharField', [], {'max_length': '55'})
        },
        'breeze.statistics': {
