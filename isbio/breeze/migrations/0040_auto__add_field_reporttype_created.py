...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReportType.created'
        db.add_column('breeze_reporttype', 'created',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(2014, 9, 21, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ReportType.created'
        db.delete_column('breeze_reporttype', 'created')
