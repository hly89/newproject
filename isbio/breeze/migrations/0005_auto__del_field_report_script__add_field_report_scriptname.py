...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Report.script'
        db.delete_column('breeze_report', 'script_id')

        # Adding field 'Report.scriptname'
        db.add_column('breeze_report', 'scriptname',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['breeze.Rscripts'], to_field='name'),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Report.script'
        db.add_column('breeze_report', 'script',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['breeze.Rscripts'], to_field='name'),
                      keep_default=False)

        # Deleting field 'Report.scriptname'
        db.delete_column('breeze_report', 'scriptname_id')
