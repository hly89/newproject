...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Script_categories'
        db.create_table('breeze_script_categories', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('category', self.gf('django.db.models.fields.CharField')(unique=True, max_length=55)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=350, blank=True)),
        ))
        db.send_create_signal('breeze', ['Script_categories'])


        # Renaming column for 'Rscripts.category' to match new field type.
        db.rename_column('breeze_rscripts', 'category', 'category_id')
        # Changing field 'Rscripts.category'
        db.alter_column('breeze_rscripts', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['breeze.Script_categories'], to_field='category'))
        # Adding index on 'Rscripts', fields ['category']
        db.create_index('breeze_rscripts', ['category_id'])


    def backwards(self, orm):
        # Removing index on 'Rscripts', fields ['category']
        db.delete_index('breeze_rscripts', ['category_id'])

        # Deleting model 'Script_categories'
        db.delete_table('breeze_script_categories')


        # Renaming column for 'Rscripts.category' to match new field type.
        db.rename_column('breeze_rscripts', 'category_id', 'category')
        # Changing field 'Rscripts.category'
        db.alter_column('breeze_rscripts', 'category', self.gf('django.db.models.fields.CharField')(max_length=25))
