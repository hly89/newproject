...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReportType.institute'
        db.add_column('breeze_reporttype', 'institute',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['breeze.Institute']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ReportType.institute'
        db.delete_column('breeze_reporttype', 'institute_id')
