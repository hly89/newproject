...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'User_date'
        db.create_table('breeze_user_date', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('install_date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('breeze', ['User_date'])

        # Adding M2M table for field install_date on 'Rscripts'
        db.create_table('breeze_rscripts_install_date', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('rscripts', models.ForeignKey(orm['breeze.rscripts'], null=False)),
            ('user_date', models.ForeignKey(orm['breeze.user_date'], null=False))
        ))
        db.create_unique('breeze_rscripts_install_date', ['rscripts_id', 'user_date_id'])


    def backwards(self, orm):
        # Deleting model 'User_date'
        db.delete_table('breeze_user_date')

        # Removing M2M table for field install_date on 'Rscripts'
        db.delete_table('breeze_rscripts_install_date')
