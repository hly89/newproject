...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Jobs.created'
        db.add_column('breeze_jobs', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 9, 23, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Jobs.created'
        db.delete_column('breeze_jobs', 'created')
