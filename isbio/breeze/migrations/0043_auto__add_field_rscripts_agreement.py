...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Rscripts.agreement'
        db.add_column('breeze_rscripts', 'agreement',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=9000, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Rscripts.agreement'
        db.delete_column('breeze_rscripts', 'agreement')
