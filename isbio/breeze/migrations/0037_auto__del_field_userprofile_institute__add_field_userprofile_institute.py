...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('breeze_userprofile', 'institute_id')

        # Adding field 'UserProfile.institute_info'
        db.add_column('breeze_userprofile', 'institute_info',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['breeze.Institute'], unique=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UserProfile.institute'
        db.add_column('breeze_userprofile', 'institute',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['breeze.Institute'], unique=True),
                      keep_default=False)

        # Deleting field 'UserProfile.institute_info'
        db.delete_column('breeze_userprofile', 'institute_info_id')
    ...
    models = {
        ...
        'breeze.userprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'institute_info': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['breeze.Institute']", 'unique': 'True'}),
            'logo': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'blank': 'True'}),
