...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field edit_access on 'Rscripts'
        db.create_table('breeze_rscripts_edit_access', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('rscripts', models.ForeignKey(orm['breeze.rscripts'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('breeze_rscripts_edit_access', ['rscripts_id', 'user_id'])


    def backwards(self, orm):
        # Removing M2M table for field edit_access on 'Rscripts'
        db.delete_table('breeze_rscripts_edit_access')
    ...
    models = {
        ...
        'breeze.project': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'institute': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['breeze.Institute']"}),
        ...
        'breeze.rscripts': {
            ...
            'agreement': ('django.db.models.fields.CharField', [], {'max_length': '9000', 'blank': 'True'}),
            'author': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            ...
            'edit_access': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'edit_scripts'", 'default': 'None', 'to': "orm['auth.User']", 'blank': 'True', 'symmetrical': 'False', 'null': 'True'}),
