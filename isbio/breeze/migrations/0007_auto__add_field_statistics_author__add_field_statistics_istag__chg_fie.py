...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Statistics.author'
        db.add_column('breeze_statistics', 'author',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Statistics.istag'
        db.add_column('breeze_statistics', 'istag',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Renaming column for 'Statistics.script' to match new field type.
        db.rename_column('breeze_statistics', 'script_id', 'script')
        # Changing field 'Statistics.script'
        db.alter_column('breeze_statistics', 'script', self.gf('django.db.models.fields.CharField')(max_length=55))
        # Removing index on 'Statistics', fields ['script']
        db.delete_index('breeze_statistics', ['script_id'])


    def backwards(self, orm):
        # Adding index on 'Statistics', fields ['script']
        db.create_index('breeze_statistics', ['script_id'])

        # Deleting field 'Statistics.author'
        db.delete_column('breeze_statistics', 'author_id')

        # Deleting field 'Statistics.istag'
        db.delete_column('breeze_statistics', 'istag')


        # Renaming column for 'Statistics.script' to match new field type.
        db.rename_column('breeze_statistics', 'script', 'script_id')
        # Changing field 'Statistics.script'
        db.alter_column('breeze_statistics', 'script_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['breeze.Rscripts']))
