...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field access on 'Rscripts'
        db.create_table('breeze_rscripts_access', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('rscripts', models.ForeignKey(orm['breeze.rscripts'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('breeze_rscripts_access', ['rscripts_id', 'user_id'])


    def backwards(self, orm):
        # Removing M2M table for field access on 'Rscripts'
        db.delete_table('breeze_rscripts_access')
