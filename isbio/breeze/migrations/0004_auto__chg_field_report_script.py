...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Report.script'
        db.alter_column('breeze_report', 'script_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['breeze.Rscripts'], to_field='name'))

    def backwards(self, orm):

        # Changing field 'Report.script'
        db.alter_column('breeze_report', 'script_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['breeze.Rscripts']))
    ...
    models = {
        ...
        'breeze.report': {
            ...
            'script': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['breeze.Rscripts']", 'to_field': "'name'"}),
