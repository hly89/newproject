...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Statistics.author' to match new field type.
        db.rename_column('breeze_statistics', 'author_id', 'author')
        # Changing field 'Statistics.author'
        db.alter_column('breeze_statistics', 'author', self.gf('django.db.models.fields.CharField')(max_length=55))
        # Removing index on 'Statistics', fields ['author']
        db.delete_index('breeze_statistics', ['author_id'])


    def backwards(self, orm):
        # Adding index on 'Statistics', fields ['author']
        db.create_index('breeze_statistics', ['author_id'])


        # Renaming column for 'Statistics.author' to match new field type.
        db.rename_column('breeze_statistics', 'author', 'author_id')
        # Changing field 'Statistics.author'
        db.alter_column('breeze_statistics', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
    ...
    models = {
        ...
        'breeze.statistics': {
            ...
            'author': ('django.db.models.fields.CharField', [], {'max_length': '55'}),
