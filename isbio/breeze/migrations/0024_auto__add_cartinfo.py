...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CartInfo'
        db.create_table('breeze_cartinfo', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('script_buyer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['breeze.Rscripts'])),
            ('date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('breeze', ['CartInfo'])


    def backwards(self, orm):
        # Deleting model 'CartInfo'
        db.delete_table('breeze_cartinfo')
