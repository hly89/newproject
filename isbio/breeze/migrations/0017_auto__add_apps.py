...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'apps'
        db.create_table('breeze_apps', (
            ('product_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['shop.Product'], unique=True, primary_key=True)),
            ('appname', self.gf('django.db.models.fields.CharField')(unique=True, max_length=35)),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('breeze', ['apps'])


    def backwards(self, orm):
        # Deleting model 'apps'
        db.delete_table('breeze_apps')
    ...
    models = {
        ...
        'breeze.apps': {
            ...
            'appname': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '35'}),
