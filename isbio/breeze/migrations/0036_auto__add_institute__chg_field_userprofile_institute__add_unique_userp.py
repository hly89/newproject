...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('breeze_institute', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('institute', self.gf('django.db.models.fields.CharField')(max_length=75)),
        ))
        db.send_create_signal('breeze', ['Institute'])


        # Renaming column for 'UserProfile.institute' to match new field type.
        db.rename_column('breeze_userprofile', 'institute', 'institute_id')
        # Changing field 'UserProfile.institute'
        db.alter_column('breeze_userprofile', 'institute_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['breeze.Institute'], unique=True))
        # Adding index on 'UserProfile', fields ['institute']
        db.create_index('breeze_userprofile', ['institute_id'])

        # Adding unique constraint on 'UserProfile', fields ['institute']
        db.create_unique('breeze_userprofile', ['institute_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'UserProfile', fields ['institute']
        db.delete_unique('breeze_userprofile', ['institute_id'])

        # Removing index on 'UserProfile', fields ['institute']
        db.delete_index('breeze_userprofile', ['institute_id'])

        # Deleting model 'Institute'
        db.delete_table('breeze_institute')


        # Renaming column for 'UserProfile.institute' to match new field type.
        db.rename_column('breeze_userprofile', 'institute_id', 'institute')
        # Changing field 'UserProfile.institute'
        db.alter_column('breeze_userprofile', 'institute', self.gf('django.db.models.fields.CharField')(max_length=75))
    ...
    models = {
        ...
        'breeze.userprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'institute': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['breeze.Institute']", 'unique': 'True'}),
            'logo': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'blank': 'True'}),
