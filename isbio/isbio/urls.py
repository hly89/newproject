...
urlpatterns = patterns('',
    ...
    #url(r'^compound-new/$', views.compound_new),
    url(r'^help/$', views.dochelp),
    url(r'^store/deletefree/$', views.deletefree),
    url(r'^store/installfree/$', views.installfree),
    url(r'^store/$', views.store),
    url(r'^store/deletenonfree/$', views.deletenonfree),
    url(r'^deletescript/(?P<sid>\d+)$', views.deletescript),
    ...
    url(r'^deletepipeline/(?P<rid>\d+)$', views.deletepipeline),
    url(r'^showdetails/(?P<sid>\d+)$', views.showdetails),
    url(r'^abortjobs/(?P<jid>\d+)$', views.abortjobs),
    url(r'^abortreports/(?P<jid>\d+)$', views.abortreports),
    ...
    url(r'^new-institute/$', views.new_institute),
